...
public class DeviceScanActivity extends ListActivity {
    ...
    protected void onResume() {
        ...
        registerReceiver(progressReceiver, new IntentFilter("progress"));
        /*
    ...
    protected void onListItemClick( ListView l , View v , int position , long id ) {
        ...
        scanLeDevice(false);
        final Intent intent = new Intent(this, ReaderService.class);
           intent.putExtra(ReaderService.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        startService(intent);
        showProgress();
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (msg.equals("dismiss")) {
                ...
                if (progressDialog != null) {
                    ...
                    Toast.makeText(context, "progress null...", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void showProgress() {
        progressDialog = ProgressDialog.show( DeviceScanActivity.this , "", "Connecting...", false, false);
    }
